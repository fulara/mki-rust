...
pub(crate) fn code_to_key(code: u32) -> KeybdKey {
    ...
    match code as i32 {
        ...
        code if Key::_0.code() == code => _0,
        code if Key::_1.code() == code => _1,
        code if Key::_2.code() == code => _2,
        code if Key::_3.code() == code => _3,
        code if Key::_4.code() == code => _4,
        code if Key::_5.code() == code => _5,
        code if Key::_6.code() == code => _6,
        code if Key::_7.code() == code => _7,
        code if Key::_8.code() == code => _8,
        code if Key::_9.code() == code => _9,
